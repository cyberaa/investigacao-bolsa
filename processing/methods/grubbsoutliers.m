function [b,idx,outliers] = grubbsoutliers(a,alpha,rep);
% [B, IDX, OUTLIERS] = grubbsoutliers(A, ALPHA, REP)
% 
...
%
% ex:
% [B,idx,outliers] = grubbsoutliers([1.1 1.3 0.9 1.2 -6.4 1.2 0.94 4.2 1.3 1.0 6.8 1.3 1.2], 0.05)
%    returns:
